...
In the resulting visualization, points representing the same digit
typically form compact clusters, indicating that t-SNE effectively
captures the local similarity among handwriting patterns. Ambiguous or
poorly written digits often appear between clusters, reflecting their
uncertain visual identity. Digits with similar shapes, such as 3 and 5,
may exhibit partial overlap in the two-dimensional embedding, showing
how t-SNE balances local cohesion with global separation.
