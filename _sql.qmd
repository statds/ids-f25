...
Take note that we have began using our other connection (srconn instead of 
...
simplifying the process of displaying data. Using both the queries shown here as
well as much more complicated queries, one can turn complex tables into 
...
1. [SQLite Tutorial (downloading SQLite not necessary)](https://www.sqlitetutorial.net/)