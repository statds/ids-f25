...
### Example Context: Boston Housing Data 
...
alpha = 0.05
if p_value < alpha:
    print(f"Reject H₀ (p = {p_value:.4f}) → Mean home values differ.")
else:
    print(f"Fail to reject H₀ (p = {p_value:.4f}) → No difference in mean home values.")
```
