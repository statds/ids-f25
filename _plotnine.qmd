...
As Wilkinson describes in *The Grammar of Graphics* [@wilkinson2012grammar], Plotnine implements the Grammar of Graphics in Python.  It is inspired by **ggplot2 in R** and allows consistent, layered visualizations.  
...
This makes visualizations flexible, reusable, and less error prone. And once you know the grammar, learning tools like **Plotnine** or **ggplot2** becomes much easier. Think of plots not as pictures, but as structured sentences written with this grammar.  


## Resources
- https://aeturrell.github.io/coding-for-economists/vis-plotnine.html
- https://realpython.com/ggplot-python/
- https://www.geeksforgeeks.org/data-visualization/data-visualization-using-plotnine-and-ggplot2-in-python/
