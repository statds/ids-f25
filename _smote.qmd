...
# pre smote
ax1.scatter(X_majority[:,0], X_majority[:,1], color='#9335E5', s=120, label='Majority')
ax1.scatter(X_minority[:,0], X_minority[:,1], color='#E00083', s=150, label='Minority')
ax1.set_xlim(0,5)
ax1.set_ylim(0,5)
ax1.set_title("Before SMOTE is applied")
ax1.legend(loc='upper left')

# post smote
ax2.scatter(X_majority[:,0], X_majority[:,1], color='#9335E5', s=120, label='Majority')
ax2.scatter(X_minority[:,0], X_minority[:,1], color='#E00083', s=150, label='Minority')
ax2.scatter(X_synthetic[:,0], X_synthetic[:,1], color='#FF9CD8', s=120, label='Synthetic')
ax2.set_xlim(0,5)
ax2.set_ylim(0,5)
ax2.set_title("After SMOTE is applied")
ax2.legend(loc='upper left')

plt.show()
```

The initial majority and minority classes are imbalanced, with the minority only
having 2 points and the majority having 8. After SMOTE is applied, the total
of minority and synthetic points equals the number of majority points.
You can see how the synthetic points are all between the initial 2 minority
points. In larger datasets, this can look almost like lines drawn between multiple
sets of minority points. The resulting dataset is more balanced, but there's 
less of a chance of overlapping data points with the originals because it's 
not duplicates.

This can also be demonstrated by:
$$
...
Looking at the bar charts, you can see the difference in class size before 
