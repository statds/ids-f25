...
p = (
    ...
    gg.labs(
        title="Decision Tree Regression on Ames Housing",
        x="Observed Log Price",
...
p = (
    ...
    + gg.geom_abline(slope=1, intercept=0, linetype="dashed")
    + gg.labs(
        title="Gradient-Boosted Regression on Ames Housing",
        x="Observed Log Price",
        y="Predicted Log Price",
    )
)
...
<!-- This section is for variable importance. -->
