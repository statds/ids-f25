...
![UConn Base Map](images/gmplot/uconn_base.png)
...
# Save map
gmapg.draw("Fenway_geocode.html")
```

![Fenway Base Map](images/gmplot/fenway.png)
...
![Uconn Markers Map](images/gmplot/uconn_markers.png)
...
gmap2a.draw( "uconn_scatter.html" )
```

![Uconn Scatter Map](images/gmplot/uconn_scatter.png)
...
![Uconn Polygon Map](images/gmplot/uconn_poly.png)
...
# Save the map
gmap4.draw("uconn_route.html")
```

![Uconn Route Map](images/gmplot/uconn_route.png)
...
# Save the map
gmap5.draw("uconn_directions.html")
```

![Uconn Directions Map](images/gmplot/uconn_directions.png)
...
As seen above, this map can be interacted with without leaving the current html. This makes folium an ideal solution for maps that need user interaction.
