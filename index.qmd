...
Please use the following table to sign up.
  ...
  ----- | ------------- | -------------------------
   ...
   10/28 | Wishneski, Emma Irene | Support Vector Machine
   ...
   11/06 | Anzalone, Matthew James | Deep Learning
   11/06 | Zhang, Mark Justin | Uniform manifold approximation and projection
   ...
   11/13 | Blake, Roger Cooley | Variable importance metrics
   11/13 | Schlessel, Jacob E | Filling missing data with multiple imputation
