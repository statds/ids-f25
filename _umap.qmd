...
```{python}
#| fig-cap: "Fuzzy balls to 4th nearest neighbor"
#| echo: false
#| message: false
#| warning: false
import matplotlib.pyplot as plt
...
This weighting ensures that nearby points have higher connection strength 
while normalizing the total influence of each point, producing a uniform 
manifold representation that preserves the underlying topology.
