...
developed to help handle those larger scenarios. This includes Borderline SMOTE,
ADASYN, STOME-ENN (Edited Nearest Neighbors), SMOTE+TOMEK, and SMOTE-NC 
(Nominal Continuous).

ADASYN, or Adaptive Synthetic Sampling Approach, focuses on finding and
handling regions where the imbalance is more severe. 
